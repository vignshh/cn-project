...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        title = QLabel("CN End-Sem Project by Group 10")
        font = title.font()
        ...
        layout.addWidget(QLabel("Made using PyQt5 and Python"))
        layout.addWidget(QLabel("For CN project"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Group 10", self)
        about_action.setStatusTip("About this Browser")
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')), "Python", self)
        navigate_action.setStatusTip("Go to Homepage")
        navigate_action.triggered.connect(self.navigate_main)
    ...
    def navigate_main(self):
        self.browser.setUrl(QUrl("https://python.org/"))
...
app.setApplicationName("Simple Web Broswer")
